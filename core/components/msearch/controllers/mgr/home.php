 ...
 */
$modx->regClientStartupScript($mSearch->config['jsUrl'].'mgr/widgets/items.grid.js');
$modx->regClientStartupScript($mSearch->config['jsUrl'].'mgr/widgets/home.panel.js');
$modx->regClientStartupScript($mSearch->config['jsUrl'].'mgr/sections/home.js');
$output = '<div id="msearch-panel-home-div"></div>';
